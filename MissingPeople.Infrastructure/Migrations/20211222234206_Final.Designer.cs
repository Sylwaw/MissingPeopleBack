...
namespace MissingPeople.Infrastructure.Migrations
{
    ...
    [Migration("20211222234206_Final")]
    partial class Final
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LastLocationPerson", b =>
                {
                    b.Property<int>("LastLocationsId")
                        .HasColumnType("integer");

                    b.Property<int>("PeopleId")
                        .HasColumnType("integer");

                    b.HasKey("LastLocationsId", "PeopleId");

                    b.HasIndex("PeopleId");

                    b.ToTable("LastLocationPerson");
                });
            ...
            modelBuilder.Entity("LastLocationPerson", b =>
                {
                    b.HasOne("MissingPeople.Core.Entities.Peoples.LastLocation", null)
                        .WithMany()
                        .HasForeignKey("LastLocationsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MissingPeople.Core.Entities.Peoples.Person", null)
                        .WithMany()
